...
let getAppUpdatePublishConfiguration = exports.getAppUpdatePublishConfiguration = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, arch, errorIfCannot) {
...
let getPublishConfigs = exports.getPublishConfigs = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, targetSpecificOptions, arch, errorIfCannot) {
        let publishers;
        ...
        if (publishers == null) {
            ...
            if (serviceName != null) {
                ...
                return [yield getResolvedPublishConfig(packager, { provider: serviceName }, arch, errorIfCannot)];
            }
        }
        if (publishers == null) {
            return [];
        ...
        return yield (_bluebirdLst2 || _load_bluebirdLst2()).default.map((0, (_builderUtil || _load_builderUtil()).asArray)(publishers), function (it) {
            return getResolvedPublishConfig(packager, typeof it === "string" ? { provider: it } : it, arch, errorIfCannot);
        });
    });
...
let getResolvedPublishConfig = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, options, arch, errorIfCannot) {
        let getInfo = (() => {
...
class PublishManager {
    ...
    artifactCreated(event) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (debug.enabled) {
                debug(`artifactCreated (isPublish: ${_this2.isPublish}): ${(0, (_builderUtil || _load_builderUtil()).safeStringifyJson)(event, new Set(["packager"]))},\n  publishConfigs: ${(0, (_builderUtil || _load_builderUtil()).safeStringifyJson)(publishConfigs)}`);
            }
            ...
            if (event.isWriteUpdateInfo && target != null && eventFile != null && !_this2.cancellationToken.cancelled && (packager.platform !== (_index || _load_index()).Platform.WINDOWS || isSuitableWindowsTarget(target))) {
                _this2.taskManager.addTask((0, (_updateInfoBuilder || _load_updateInfoBuilder()).createUpdateInfoTasks)(event, publishConfigs).then(function (it) {
                    return _this2.updateFileWriteTask.push(...it);
                }));
            }
        })();
    }
    ...
    awaitTasks() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield (0, (_updateInfoBuilder || _load_updateInfoBuilder()).writeUpdateInfoFiles)(updateInfoFileTasks, _this3.packager);
            yield _this3.taskManager.awaitTasks();
        })();
    }
}
