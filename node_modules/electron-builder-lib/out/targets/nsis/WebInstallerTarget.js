    ...
    configureDefines(oneClick, defines) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (appPackageUrl == null) {
                const publishConfigs = yield (0, (_PublishManager || _load_PublishManager()).getPublishConfigsForUpdateInfo)(packager, (yield (0, (_PublishManager || _load_PublishManager()).getPublishConfigs)(packager, _this.options, null, false)), null);
