...
class PlatformPackager {
    ...
    getExtraFileMatchers(isResources, appOutDir, options) {
        ...
        return (0, (_fileMatcher || _load_fileMatcher()).getFileMatchers)(this.config, isResources ? "extraResources" : "extraFiles", this.projectDir, base, options);
    }
    ...
    doPack(outDir, appOutDir, platformName, arch, platformSpecificBuildOptions, targets) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const extraResourceMatchers = _this2.getExtraFileMatchers(true, appOutDir, getFileMatchersOptions);
            computeParsedPatterns(extraResourceMatchers);
            const extraFileMatchers = _this2.getExtraFileMatchers(false, appOutDir, getFileMatchersOptions);
    ...
    copyAppFiles(taskManager, asarOptions, resourcePath, outDir, platformSpecificBuildOptions, excludePatterns, macroExpander) {
        ...
        if (this.info.isPrepackedAppAsar) {
            ...
            const unpackPattern = (0, (_fileMatcher || _load_fileMatcher()).getFileMatchers)(config, "asarUnpack", appDir, defaultDestination, {
                macroExpander,
                customBuildOptions: platformSpecificBuildOptions,
                outDir
            });
